        ...
        <div class="afisha_block">
          <div class="afisha_container">
            <div class="afisha_column">
              ...
              <div class="afisha_perfomance_day">
                ...
                <div class="afisha_events_list">
                  <div class="afisha_perfomance_event">
                    <img
                      class="event_photo_mobile"
                      src="/wp-content/themes/my_theme/assets/img/afishaInMain.png"
                      alt=""
                    />
                    <img
                      class="event_photo_desktop"
                      src="/wp-content/themes/my_theme/assets/img/afishaInMain.png"
                      alt=""
                    />
                    ...
                    <a class="buy_ticket" href="my-website.com/afisha">Купить билет</a>
                  </div>
              ...
              <!-- Перейти в афишу -> -->
              <a class="go_to_block" href="my-website.com/afisha">
          ...
          <div class="projects_container">
            <div class="projects_column">
              ...
              <div class="projects_list">
                <a class="project" href="my-website.com/project">
                  <img
                    class="project_photo_desktop"
                    src="/wp-content/themes/my_theme/assets/img/afishaInMain.png"
                    alt=""
                  />
                  <img
                    class="project_photo_mobile"
                    src="/wp-content/themes/my_theme/assets/img/afishaInMain.png"
                    alt=""
                  />
              ...
              <div class="go_to_block">
                <a class="go_to_text" href="my-website.com/projects">Перейти в проекты</a>
                <img class="go_to_pointer" src="/wp-content/themes/my_theme/assets/img/go_to_pointer.svg" alt="" />
                <!-- ./go_to_block -->
              </div>
          ...
          <div class="press_container">
            ...
            <div class="articles_container">
              <div class="article_wraper">
                <div class="article">
                  <img class="press_img" src="/wp-content/themes/my_theme/assets/img/press_photo.png" alt="" />
            ...
            <div class="go_to_press">
              <a class="go_to_text" href="my-website.com/press">Перейти в прессу</a>
              <img class="go_to_pointer" src="/wp-content/themes/my_theme/assets/img/go_to_pointer.svg" alt="" />
            </div>
            <!-- /.press_container -->
          </div>
